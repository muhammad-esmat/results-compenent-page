...
<img src="./solution-pics/collage.png" width="500" height="300" alt="Results summary component solution">
...
3. **Semantic HTML**: Understood the importance of using proper heading elements (`<h2>`, `<h3>`) instead of `<p>` tags for content that represents headings, improving accessibility and document structure.
